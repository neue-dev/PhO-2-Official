...
app.get('/trademark', (req, res) => {
  res.sendFile('./public/pho2/trademark.js', { root: __dirname });
})

app.get('/pho2', (req, res) => {
  res.sendFile('./public/pho2/pho2.js', { root: __dirname });
})

app.get('/dom', (req, res) => {
  res.sendFile('./public/core/dom.js', { root: __dirname });
})

app.get('/component', (req, res) => {
  res.sendFile('./public/core/component.js', { root: __dirname });
})
